  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-300 bg-background shadow-sm hover:bg-accent hover:text-accent-red-500",
        outlineBlue:
          "text-blue-600 border border-gray-300 bg-background shadow-sm transition-colors duration-1000 hover:bg-gray-200 hover:text-gray-900 focus-visible:ring-green hover:outline-none",
        secondary:
